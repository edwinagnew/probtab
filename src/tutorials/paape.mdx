...
<Accordion >
      <Accordion.Item eventKey="0">
        ...
        <Accordion.Body>
            ...
            1. This is a fact I already knew  
            2. I learnt about the capital of France when I was 6 and have stored that fact in my memeory ever since
            3. My hippocampus sent a signal to my amygdala
            4. Neuron 45 fired which sent a response down synapse 423, which triggered neuron ..., which fired a response in neuron 3282
            5. A certain cluster of calcium ions diffused in a certain way
            6. Something something shrondingers equation
